...
local Vte = LuaGObject.require('Vte', '2.90')
...
local app = Gtk.Application { application_id = 'org.LuaGObject.samples.gtkconsole' }
...
window.title = 'Different' <Enter>
	...
	-- For convenience, propagate 'LuaGObject' into the global namespace.
