...
--
-- Sample LuaGObject application for Gio files, streams and usage of
...
local assert = LuaGObject.assert

local app = Gio.Application { application_id = 'org.LuaGObject.samples.giostream' }
