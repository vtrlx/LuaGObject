...
local Gdk = LuaGObject.require('Gdk', '3.0')
local Pango = LuaGObject.Pango
local GtkSource = LuaGObject.require('GtkSource', '3.0')
...
local function Console()
	...
	-- Gtk.BindingKey mechanism, but LuaGObject still lacks possibility to
...
local app = Gtk.Application { application_id = 'org.LuaGObject.gtkconsole' }
