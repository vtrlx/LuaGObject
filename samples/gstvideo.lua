...
local GdkX11 = LuaGObject.require('GdkX11', '3.0')
local Gst  = LuaGObject.Gst
if tonumber(Gst._version) >= 1.0 then
	local GstVideo = LuaGObject.GstVideo
end

local app = Gtk.Application { application_id = 'org.LuaGObject.samples.gstvideo' }

local window = Gtk.Window {
	title = "LuaGObject Based Video Player",
	Gtk.Box {
